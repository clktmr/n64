...
func (x Int8) Floor() int      { return int(x) }
...
func (x UInt8) Floor() int        { return int(x) }
...
func (x Int16) Floor() int        { return int(x) }
...
func (x UInt16) Floor() int          { return int(x) }
...
func (x Int32) Floor() int        { return int(x) }
...
func (x UInt32) Floor() int          { return int(x) }
...
func (x Int64) Floor() int        { return int(x) }
...
func (x UInt64) Floor() int          { return int(x) }
